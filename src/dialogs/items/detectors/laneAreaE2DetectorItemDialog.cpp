#include "laneAreaE2DetectorItemDialog.h"
#include "ui_laneAreaE2DetectorItemDialog.h"

#include "../../../items/detectors/laneAreaE2DetectorItem.h"


laneAreaE2DetectorItemDialog::laneAreaE2DetectorItemDialog(eNetEditorMainWindow *eNetEditorMainW) : abstractDetectorItemDialog(eNetEditorMainW), ui(new Ui::laneAreaE2DetectorItemDialog)
{
    ui->setupUi(this);
}

laneAreaE2DetectorItemDialog::~laneAreaE2DetectorItemDialog()
{
    delete ui;
}

void laneAreaE2DetectorItemDialog::resetParameters()
{
    // Set setTmpExtraParameter1Name with the value of the Item
    setTmpExtraParameter1Name(E2->getExtraParameter1Name());

    // Set setTmpExtraParameter1Value with the value of the Item
    setTmpExtraParameter1Value(E2->getExtraParameter1Value());

    // Set setTmpExtraParameter2Name with the value of the Item
    setTmpExtraParameter2Name(E2->getExtraParameter2Name());

    // Set setTmpExtraParameter2Value with the value of the Item
    setTmpExtraParameter2Value(E2->getExtraParameter2Value());

    // Set setTmpExtraParameter3Name with the value of the Item
    setTmpExtraParameter3Name(E2->getExtraParameter3Name());

    // Set setTmpExtraParameter3Value with the value of the Item
    setTmpExtraParameter3Value(E2->getExtraParameter3Value());
}

void laneAreaE2DetectorItemDialog::updateParameters()
{
    // If custom parameter 1 was changed
    if(E2->getExtraParameter1Name() != NULL)
    {
        // Change Button text
        ui->ButtonCustomParameter1Name->setText(E2->getExtraParameter1Name());

        // Enable Text
        ui->TextCustomParameter1Value->setEnabled(true);

        // Change text
        ui->TextCustomParameter1Value->setText(E2->getExtraParameter1Value());
    ...
    if(E2->getExtraParameter2Name() != NULL)
    {
        // Change Button text
        ui->ButtonCustomParameter2Name->setText(E2->getExtraParameter2Name());

        // Enable Text
        ui->TextCustomParameter2Value->setEnabled(true);

        // Change text
        ui->TextCustomParameter2Value->setText(E2->getExtraParameter2Value());
    ...
    if(E2->getExtraParameter3Name() != NULL)
    {
        // Change Button text
        ui->ButtonCustomParameter3Name->setText(E2->getExtraParameter3Name());

        // Enable Text
        ui->TextCustomParameter3Value->setEnabled(true);

        // Change text
        ui->TextCustomParameter3Value->setText(E2->getExtraParameter3Value());
...
void laneAreaE2DetectorItemDialog::openItemDialog(eNetEditorItem *item)
{
    // Open Dialog
    show();
}

void laneAreaE2DetectorItemDialog::on_ButtonAccept_released()
{

}

void laneAreaE2DetectorItemDialog::on_ButtonCancel_released()
{

}

void laneAreaE2DetectorItemDialog::on_ButtonReset_released()
{

}

void laneAreaE2DetectorItemDialog::on_ButtonCustomParameter1Name_released()
{
...
void laneAreaE2DetectorItemDialog::on_ButtonCustomParameter2Name_released()
{
    // Get QString with the name of parameter
...
void laneAreaE2DetectorItemDialog::on_ButtonCustomParameter3Name_released()
{
    // Get QString with the name of parameter
...
void laneAreaE2DetectorItemDialog::on_TextCustomParameter1Value_textChanged()
{
    setTmpExtraParameter1Value(ui->TextCustomParameter1Value->toPlainText());
}

void laneAreaE2DetectorItemDialog::on_TextCustomParameter2Value_textChanged()
{
    setTmpExtraParameter2Value(ui->TextCustomParameter2Value->toPlainText());
}

void laneAreaE2DetectorItemDialog::on_TextCustomParameter3Value_textChanged()
{
    setTmpExtraParameter3Value(ui->TextCustomParameter3Value->toPlainText());
}

void laneAreaE2DetectorItemDialog::on_TextPosition_textChanged()
{

}

void laneAreaE2DetectorItemDialog::on_TextFrequency_textChanged()
{

}

void laneAreaE2DetectorItemDialog::on_TextFilename_textChanged()
{
